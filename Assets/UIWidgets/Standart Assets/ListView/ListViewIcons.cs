...
namespace UIWidgets {
	...
	public class ListViewIcons : ListViewCustom<ListViewIconsItemComponent,ListViewIconsItemDescription> {
		...
		{
			component.HighlightColoring(HighlightedColor, HighlightedBackgroundColor);
		}
		...
		{
			component.SelectColoring(SelectedColor, SelectedBackgroundColor);
		}
		...
		protected override void DefaultColoring(ListViewIconsItemComponent component)
		{
			if (component!=null)
			{
				component.DefaultColoring(DefaultColor, DefaultBackgroundColor);
			}
		}
	}
}